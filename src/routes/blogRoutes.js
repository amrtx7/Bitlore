...
router.delete('/blog/:id',requireAuth,checkUser,requireBlogOwner,blogController.deleteBlog)
router.get('/blog/:id/edit',requireAuth,checkUser,requireBlogOwner,blogController.getEditBlog)
router.put('/blog/:id/edit',requireAuth,checkUser,requireBlogOwner,blogController.putEditBlog)
